...
#if DEBUG_GPP
                  write(111, '(a2,e14.6,",",e14.6)') '1,',Atm_Conc(82,53,1,1),Atm_Conc(82,53,1,2)
#endif
    call Atm_POP_ReactTransformSteply
#if DEBUG_GPP
                  write(111, '(a2,e14.6,",",e14.6)') '2,',Atm_Conc(82,53,1,1),Atm_Conc(82,53,1,2)
#endif
    call Atm_POP_PartitDegrCoefs
#if DEBUG_GPP
                  write(111, '(a2,e14.6,",",e14.6)') '3,',Atm_Conc(82,53,1,1),Atm_Conc(82,53,1,2)
#endif
    call Atm_POP_Partitioning(Subs)
#if DEBUG_GPP
                  write(111, '(a2,e14.6,",",e14.6)') '4,',Atm_Conc(82,53,1,1),Atm_Conc(82,53,1,2)
#endif
    call Atm_POP_Degradation(Subs)
#if DEBUG_GPP
                  write(111, '(a2,e14.6,",",e14.6)') '5,',Atm_Conc(82,53,1,1),Atm_Conc(82,53,1,2)
#endif
...
#ifdef DEBUG_MODE
			print *, 'Atm form types: ', (FormType(i), i=1, sFormNum(Atm,Subs))
#endif
!------------------------------------------------------------------
		  case('Form ID')
