...
!		      read(2,*) AName(AN), AUnit(AN), Cp0(AN), CpT(AN), CorrectA(AN), crc(AN)
		    end do
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1
            ...
            call checkNC(nf90_inq_varid(ncid_in, AName(AN)(1:len_trim(AName(AN))-1), var_id_in), 408)
            call checkNC(nf90_get_var(ncid_in, var_id_in, qreact_buf, start3, count3), 409)
            ...
            call checkNC(nf90_close(ncid_in), 410)
        end do
    enddo  ! nDay
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            ...
            call checkNC(nf90_inq_varid(ncid_in, RName(RN)(1:len_trim(RName(RN))-1), var_id_in), 411)
            call checkNC(nf90_get_var(ncid_in, var_id_in, qreact_buf, start3, count3), 412)
            ...
            enddo
            where(Aerofield <= 0.) Aerofield = Zero
            call checkNC(nf90_close(ncid_in), 413)
...
!                  Kp(AN) = Cp0(AN) * exp(CpT(AN)*(1./Tair - 1./T0)) * AeroConc(AN,i,j,k)*crc(AN)
                  Summ = Summ + Kp(AN)
                end do
                kpt(i,j,k,Period,NPOP) = Summ / (1. + Summ)
!===========                
                if(i==82.and.j==53.and.k==1)&
                  &write(111, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==113.and.j==49.and.k==1)&
                  &write(112, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==96.and.j==63.and.k==1)&
                  &write(113, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==102.and.j==58.and.k==1)&
                  &write(114, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==95.and.j==45.and.k==1)&
                  &write(115, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==102.and.j==52.and.k==1)&
                  &write(116, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==107.and.j==62.and.k==1)&
                  &write(117, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==140.and.j==74.and.k==1)&
                  &write(118, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==65.and.j==24.and.k==1)&
                  &write(119, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==67.and.j==19.and.k==1)&
                  &write(120, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==63.and.j==34.and.k==1)&
                  &write(121, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==73.and.j==23.and.k==1)&
                  &write(122, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==77.and.j==29.and.k==1)&
                  &write(123, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==145.and.j==77.and.k==1)&
                  &write(124, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==136.and.j==96.and.k==1)&
                  &write(125, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==136.and.j==80.and.k==1)&
                  &write(126, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==93.and.j==47.and.k==1)&
                  &write(127, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==87.and.j==50.and.k==1)&
                  &write(128, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==76.and.j==35.and.k==1)&
                  &write(129, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==89.and.j==37.and.k==1)&
                  &write(130, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==71.and.j==45.and.k==1)&
                  &write(131, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==82.and.j==43.and.k==1)&
                  &write(132, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==73.and.j==61.and.k==1)&
                  &write(133, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==67.and.j==65.and.k==1)&
                  &write(134, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==72.and.j==53.and.k==1)&
                  &write(135, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==115.and.j==40.and.k==1)&
                  &write(136, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==128.and.j==66.and.k==1)&
                  &write(137, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==87.and.j==56.and.k==1)&
                  &write(138, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==96.and.j==71.and.k==1)&
                  &write(139, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==105.and.j==123.and.k==1)&
                  &write(140, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==131.and.j==61.and.k==1)&
                  &write(141, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==120.and.j==60.and.k==1)&
                  &write(142, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==105.and.j==69.and.k==1)&
                  &write(143, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==108.and.j==66.and.k==1)&
                  &write(144, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==119.and.j==76.and.k==1)&
                  &write(145, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
                if(i==113.and.j==39.and.k==1)&
                  &write(146, '(6(e14.6,","),i3)') Tair,AeroConc(1,i,j,k),AeroConc(2,i,j,k),AeroConc(3,i,j,k),&
            	                                      &Atm_Conc(i,j,k,1),Atm_Conc(j,j,k,2),Period
!===========                
