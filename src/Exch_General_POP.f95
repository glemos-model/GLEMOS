...
#ifdef DEBUG_GPP
               write(111, '(a2,e14.6,a1,e14.6)') '6,',Atm_Conc(82,53,1,1),',',Atm_Conc(82,53,1,2)
#endif
...
#ifdef DEBUG_GPP
               write(111, '(a2,e14.6,a1,e14.6)') '7,',Atm_Conc(82,53,1,1),',',Atm_Conc(82,53,1,2)
#endif
...
#ifdef WO_REEMIS
          ExchVel(:,0) = 0.        ! Switch off re-emission flux
#endif
#ifdef WO_DRYDEPGAS
          ExchVel(0,:) = 0.        ! Switch off dry gaseous deposition flux
#endif
#ifdef WO_DRYDEPPART
          DryDepVel(:) = 0.        ! Switch off dry part deposition flux
#endif
